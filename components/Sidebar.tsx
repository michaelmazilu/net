...
export const Sidebar: React.FC = () => {
  ...
  if (loading) {
    return (<div className="w-64 h-screen bg-[#262626] text-white flex flex-col items-start p-4 shadow-md font-poppins">
    ...
    <div className="w-64 h-screen bg-[#262626] text-white flex flex-col items-start p-4 shadow-md font-poppins">
      ...
      {topics.map(
        (
          ...
          <Button key={topic.id} className="flex items-center w-full rounded-xl text-lg font-medium my-4" variant="ghost">
            {topic.title}
          </Button>
        )
      )}
